                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input  type="periode" class="form-control datea" name="search_periode" id="search_periode" placeholder="Periode">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
    ...
    var oTable = $('#user_table').DataTable({
        ...
        ajax:{
            ...
            data: function (d) {
                ...
                d.nomor = $('input[name=search_kantor]').val();
            }
        },
        columns: [
