...
@section('content')
    <div class="preloader flex-column justify-content-center align-items-center">
        ...
        <img src="pictures/tcm_new.png" class="animation__shake" alt="Preloader Image" width="400" height="400">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header border-0">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title">Customer Akses</h3>
                        {{-- <a href="#">View Report</a> --}}
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="position-relative mb-4">
                        <canvas id="customers-chart" height="430"></canvas>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="position-relative mb-4">
                        <canvas id="tradein-chart" height="430"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    @section('js')
        ...
        <script src="https://raw.githubusercontent.com/emn178/chartjs-plugin-labels/master/src/chartjs-plugin-labels.js">
        </script>
        <script>
            $(function() {
                $("#example1").DataTable({
            ...
            $(function() {
                ...
                var salesChart = new Chart($salesChart, {
                    type: 'bar',
                    data: {
                        labels: ['JAN', 'FEB', 'MAR', 'APR', 'MEY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV',
                            'DEC', 'TARGET'
                        ],
                        datasets: [{
                            ...
                            borderColor: '#007bff',
                            data: [
                                {{ $chartinput->jan . ',' . $chartinput->feb . ',' . $chartinput->mar . ',' . $chartinput->apr . ',' . $chartinput->mei . ',' . $chartinput->jun . ',' . $chartinput->jul . ',' . $chartinput->aug . ',' . $chartinput->sep . ',' . $chartinput->okt . ',' . $chartinput->nov . ',' . $chartinput->des . ',100' }}]
                        }]
                    },
                    options: {
                ...
                var $customerChart = $('#customers-chart')
                ...
                var $tradeinChart = $('#tradein-chart')
                var tradeinChart = new Chart($tradeinChart, {
                    data: {
                        labels: ['APRIL', 'MEI', 'JUN'],
                        datasets: [{
                            type: 'line',
