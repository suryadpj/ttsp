...
<form action="dashboardsales" method="get">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body table-responsive">
                <table width="100%">
                    <tr>
                        <td rowspan="7" class="verticalTableHeader" width="5%">Supporting KPI of GP Vehicle Ratio</td>
                        <td>RS acv.</td>
                    ...
                    <tr>
                        <td>AO Report Submission</td>
                        <td><div id="chart6"></div></td>
                    </tr>
                    <tr>
                        <td>O/S Matching ratio</td>
                        <td><div id="chart7"></div></td>
                    </tr>
                    <tr>
                        <td>Trade In Ratio</td>
                        <td><div id="chart8"></div></td>
                    </tr>
                    <tr>
                        <td>Salesperson Productivity</td>
                        <td><div id="chart9"></div></td>
                    </tr>
                    <tr>
                        <td>Salesperson Turn Over Ratio</td>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body table-responsive">
                <table width="100%">
                    <tr>
                        <td rowspan="2" class="verticalTableHeader" width="5%">Supporting KPI of GP TCO Ratio</td>
                        <td>TCO I/R</td>
                    ...
                    <tr>
                        <td rowspan="5" class="verticalTableHeader">Supporting KPI of GP Other Income Ratio</td>
                        <td>Credit Ratio</td>
...
<script>
    ...
    var options4 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19.",".$kpires->target19 }}]
        },{
            name: 'Actual',
    ...
    var options5 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16.",".$kpires->target16 }}]
        },{
            name: 'Actual',
    ...
    var options6 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17.",".$kpires->target17 }}]
        },{
            name: 'Actual',
    ...
    var options7 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18.",".$kpires->target18 }}]
        },{
            name: 'Actual',
    ...
    var options8 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49.",".$kpires->target49 }}]
        },{
            name: 'Actual',
    ...
    var options9 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50.",".$kpires->target50 }}]
        },{
            name: 'Actual',
    ...
    var options10 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52.",".$kpires->target52 }}]
        },{
            name: 'Actual',
    ...
    var options11 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11.",".$kpires->target11 }}]
        },{
            name: 'Actual',
    ...
    var options12 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15.",".$kpires->target15 }}]
        },{
            name: 'Actual',
    ...
    var options13 = {
        ...
        series: [{
            name: 'N-1',
            data: [{{ $kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13.",".$kpires->target13 }}]
        },{
            name: 'N',
    ...
    var options14 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14.",".$kpires->target14 }}]
        },{
            name: 'Actual',
    ...
    var options15 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12.",".$kpires->target12 }}]
        },{
            name: 'Actual',
    ...
    var options17 = {
        ...
        series: [{
            name: 'Target',
            data: [{{ $kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25.",".$kpires->target25 }}]
        },{
            name: 'Actual',
